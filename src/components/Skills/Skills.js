...
const WordClouds = () => {
  return (
    ...
    >
      <p style={{ top: 50, left: '100%', fontSize: 13 }}>HTML5</p>
      <p style={{ top: 0, left: 0, fontSize: 25 }}>React</p>
      <p style={{ top: 200, left: -60, fontSize: 14 }}>CSS3</p>
      <p style={{ top: '40%', left: '35%', fontSize: 23 }}>Python</p>
      <p style={{ top: 40, left: '75%', fontSize: 12 }}>Java</p>
      <p style={{ top: 380, left: '85%', fontSize: 18 }}>MongoDB</p>
      <p style={{ top: 320, left: '65%', fontSize: 18 }}>SQL</p>
      <p style={{ top: 350, left: 150, fontSize: 20 }}>PHP</p>
      <p style={{ top: 120, left: '22%', fontSize: 18 }}>Angular</p>
    </Parallax>
  );
};
